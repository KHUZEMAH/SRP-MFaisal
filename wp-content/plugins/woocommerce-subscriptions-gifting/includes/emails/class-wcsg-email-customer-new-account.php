...
class WCSG_Email_Customer_New_Account extends WC_Email {
	...
	public function __construct() {
		...
		add_action( 'wcsg_created_customer_notification', array( $this, 'trigger' ), 10, 5 );
	 ...
	 */
	public function trigger( $user_id, $reset_key, $subscription_purchaser, $recipient_name, $recipient_message ) {
