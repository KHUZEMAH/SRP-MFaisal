...
<table class="shop_table shop_table_responsive my_account_orders woocommerce-orders-table test_dev woocommerce-MyAccount-orders woocommerce-orders-table--orders">
