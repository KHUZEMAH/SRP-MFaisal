...
<table class="shop_table shop_table_responsive test_dev my_account_orders woocommerce-orders-table woocommerce-MyAccount-orders woocommerce-orders-table--orders">
