                        ...
                        $super_admin_parsed_template = str_replace($super_admin_template_vars, $super_admin_dynamic_vars, $super_admin_template);
                          ...
                          ?>
								...
								jQuery(document).ready(function(){
									var attempt = jQuery('#content-wrap > div > div.transcation-info > span:nth-child(1)').text().slice(16);
									if(!attempt || attempt == ""){
										var urlParams = window.location.origin;
										window.location.replace(urlParams)
									}
									
									// for enhance ecommerce
									dataLayer.push({
										'event': 'EE_Purchase',
										'ecommerce': {
											'purchase': {
							...
							if (isset($_SESSION['mc_cid'])){
									...
									$product_id = $level;
									$product_price =  $final_amount;
									
							?>        
									//jQuery(document).ready(function(){
									//jQuery(window).load(function() {
										
										var transection_id 		= 	'<?php echo $invoice_number; ?>';
										var transection_amount 	= 	'<?php echo $final_amount; ?>';
