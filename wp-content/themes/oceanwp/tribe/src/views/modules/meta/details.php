...
<div class="tribe-events-meta-group tribe-events-meta-group-details" style="background-color: red;">
	...
	<dl>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dt class="tribe-events-event-url-label"> <?php esc_html_e( 'Event Details:', 'the-events-calendar' ); ?> </dt>
